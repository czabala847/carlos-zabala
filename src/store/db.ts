...
export const db: Project[] = [
  ...
  },
  {
    ...
    name: "Gifs App",
    description:
      "Proyecto de búsqueda de gifs por medio de la API giphy, la aplicación permite buscar gifs relacionados a la busqueda que se le suministre en en la barra de búsqueda.",
